var UniteSettingsRev = null;

(function(jQuery) {

UniteSettingsRev = new function(){
		...
		jQuery(arrControls[this.name]).each(function(){
			...
			switch(this.type){
				...
				case "hide":
					...
					// patch for hide hr in other fieldset
					if (this.name.length == 3 && this.name.substr(0, 2) == 'hr' && (controlName == 'navigaion_type' || controlName == 'navigation_arrows'))
					{
						childRow = jQuery('#' + this.name + '_row.hrrow');
					}
