<?php
require_once Mage::getBaseDir('base') . DS . 'lib' . DS . 'Magegiant' . DS . 'Author' . DS . 'OAuth.php';
class Magegiant_LinkedInLogin_Helper_LinkedIn extends Mage_Core_Helper_Abstract
{
	...
	public function setParams($consumer_key, $consumer_secret, $oauth_callback = null)
	{
		if ($oauth_callback) {
	...
	public function httpRequest($url, $auth_header = null, $method, $body = null)
	{
