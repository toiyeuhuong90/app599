...
class Nwdthemes_Revslider_Block_Adminhtml_Slider_Template_Edit extends Mage_Adminhtml_Block_Template {

	private $_sliderTemplate = true;
	...
	public function __construct() {
		...
		if(!empty($sliderID)){
			...
			$this->assign('arrFieldsParams', array());
