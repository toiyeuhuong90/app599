...
class Fooman_PdfCustomiser_Model_System_Fonts
{
    ...
    public function toOptionArray()
    {
        $preLoadedFonts = array(
            ...
            'cid0cs' => Mage::helper('pdfcustomiser')->__('System Font - Chinese Simplified'),
            'cid0ct' => Mage::helper('pdfcustomiser')->__('System Font - Chinese Traditional'),
            'cid0jp' => Mage::helper('pdfcustomiser')->__('System Font - Japanese'),
            'cid0kr' => Mage::helper('pdfcustomiser')->__('System Font - Korean')
        );
