<?php
class QSoft_CustomerMeasure_Block_Adminhtml_Widget_Form_Element_Browser
    ...
    public function __construct(){
        parent::__construct();
        $this->setTemplate('qsoft/adminhtml/widget/form/element/browser.phtml');
    }
    ...
    protected function _prepareLayout(){
        ...
        $browserBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'button',  array(
            'label'     => '...',
            'title'     => Mage::helper('qsoft_customermeasure')->__('Click to browser media'),
            'type'      => 'button',
            'onclick'   => sprintf('QS.MediabrowserUtility.openDialog(\'%s\')',
        ...
        $clearBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'button',  array(
            'label'     => 'x',
            'title'     => Mage::helper('qsoft_customermeasure')->__('Click to clear value'),
            'type'      => 'button',
