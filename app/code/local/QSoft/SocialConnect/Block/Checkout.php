...
class QSoft_SocialConnect_Block_Checkout extends Mage_Core_Block_Template
{
    ...
    protected function _construct()
    {
        ...
        Mage::register('qsoft_socialconnect_button_text', $this->__('Continue'), true);

        $this->setTemplate('qsoft/socialconnect/checkout.phtml');
    }
