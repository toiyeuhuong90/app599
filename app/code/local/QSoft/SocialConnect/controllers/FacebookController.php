...
class QSoft_SocialConnect_FacebookController extends QSoft_SocialConnect_Controller_Abstract
{

    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        Mage::helper('qsoft_socialconnect/facebook')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if($errorCode) {
            ...
            if($errorCode === 'access_denied') {
                Mage::getSingleton('core/session')
                    ->addNotice(
                        $this->__('Facebook Connection process aborted.')
                    );
        ...
        if ($code) {
            /** @var QSoft_SocialConnect_Helper_Facebook $helper */
            $helper = Mage::helper('qsoft_socialconnect/facebook');

            // Facebook API green light - proceed
            /** @var QSoft_SocialConnect_Model_Facebook_Info $info */
            $info = Mage::getModel('qsoft_socialconnect/facebook_info');
