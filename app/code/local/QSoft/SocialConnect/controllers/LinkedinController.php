...
class QSoft_SocialConnect_LinkedinController extends QSoft_SocialConnect_Controller_Abstract
{

    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        Mage::helper('qsoft_socialconnect/linkedin')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $info = Mage::getModel('qsoft_socialconnect/linkedin_info')->load();
            /* @var $info QSoft_SocialConnect_Model_Linkedin_Userinfo */

            $token = $info->getClient()->getAccessToken();

            $customersByLinkedinId = Mage::helper('qsoft_socialconnect/linkedin')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('qsoft_socialconnect/linkedin')->connectByLinkedinId(
                    $customer,
                    $info->getId(),
                    $token
                );
            ...
            if($customersByLinkedinId->getSize()) {
                ...
                Mage::helper('qsoft_socialconnect/linkedin')->loginByCustomer($customer);
            ...
            $customersByEmail = Mage::helper('qsoft_socialconnect/linkedin')
            ...
            Mage::helper('qsoft_socialconnect/linkedin')->connectByCreatingAccount(
