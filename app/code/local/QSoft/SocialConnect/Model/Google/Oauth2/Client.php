...
class QSoft_SocialConnect_Model_Google_Oauth2_Client
{
    const REDIRECT_URI_ROUTE = 'socialconnect/google/connect';

    const XML_PATH_ENABLED = 'social_cfg/qsoft_socialconnect_google/enabled';
    const XML_PATH_CLIENT_ID = 'social_cfg/qsoft_socialconnect_google/client_id';
    const XML_PATH_CLIENT_SECRET = 'social_cfg/qsoft_socialconnect_google/client_secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new QSoft_SocialConnect_Model_Google_Oauth2_Exception($message);
            } else {
                $message = sprintf(
                    Mage::helper('qsoft_socialconnect')
