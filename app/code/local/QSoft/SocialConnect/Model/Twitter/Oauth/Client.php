...
class QSoft_SocialConnect_Model_Twitter_Oauth_Client
{
    ...
    const XML_PATH_ENABLED = 'social_cfg/qsoft_socialconnect_twitter/enabled';
    const XML_PATH_CLIENT_ID = 'social_cfg/qsoft_socialconnect_twitter/client_id';
    const XML_PATH_CLIENT_SECRET = 'social_cfg/qsoft_socialconnect_twitter/client_secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401 || $status == 429)) {
                ...
                throw new QSoft_SocialConnect_Model_Twitter_Oauth_Exception($message);
            } else {
                $message = sprintf(
                    Mage::helper('qsoft_socialconnect')
