<?php
class QSoft_Onestepcheckout_ExpressController extends QSoft_Onestepcheckout_Controller_Express_Abstract
{
    /**
         * Config mode type
         *
...
//					Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_LINK, $_secure). 'onestepcheckout/express/cancel',
//					Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_LINK, $_secure) . 'checkout/onepage/success'
//			);
//
...
//					Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_LINK, $_secure) . 'onestepcheckout/express/return',
//					Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_LINK, $_secure) . 'onestepcheckout/express/cancel',
//					1
//				);
//			}
...
//
//			$paypalUrl =  Mage::helper('onestepcheckout')->getPayPalExpressUrl($token);
//
