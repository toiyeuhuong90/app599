<?php
class QSoft_Onestepcheckout_IndexController extends Mage_Checkout_Controller_Action{
	...
	protected function initDefaultAddress()
	{
		...
		$ip_country =  Mage::getStoreConfig(self::XML_PATH_GEO_COUNTRY) ? Mage::helper('onestepcheckout/country')->get() : $countryId;
		$countryId =  !empty($ip_country)?$ip_country:$countryId;
		$ip_city =  Mage::getStoreConfig(self::XML_PATH_GEO_CITY) ? Mage::helper('onestepcheckout/city')->get() : false;
