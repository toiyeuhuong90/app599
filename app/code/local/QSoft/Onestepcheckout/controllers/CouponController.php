...
class QSoft_Onestepcheckout_CouponController extends Mage_Core_Controller_Front_Action{
	...
	public function couponPostAction(){
		...
		try {
			...
			$block->setTemplate('qsoft/onestepcheckout/onepage/coupon.phtml');
			$responseData['coupon'] = $block->toHtml();
			
			// check if need to reload shipping methods
			$ship_changed = Mage::helper('onestepcheckout')->checkUpdatedShippingMethods($ship_methods_before, $ship_methods_after);
			if($ship_changed)
