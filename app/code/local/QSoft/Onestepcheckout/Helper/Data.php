<?php
class QSoft_Onestepcheckout_Helper_Data extends Mage_Core_Helper_Abstract{
	...
	const XML_PATH_TERMS_TYPE = 'onestepcheckout/default/terms_type';
	
	const XML_PATH_COMMENT = 'onestepcheckout/default/comment';
	
	const XML_PATH_DISCOUNT = 'onestepcheckout/default/discount';
	
	const XML_PAYPAL_LIGHTBOX_SANDBOX = 'onestepcheckout/paypal/sandbox';
	
	const XML_PAYPAL_LIGHTBOX_ENABLED = 'onestepcheckout/paypal/status';
