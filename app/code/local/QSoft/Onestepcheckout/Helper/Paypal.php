<?php
class QSoft_Onestepcheckout_Helper_Paypal extends Mage_Customer_Helper_Data {
	
	const RETURN_URL = 'onestepcheckout/paypal/return';
	
	const XML_PATH_ENABLED = 'onestepcheckout/paypallogin/status';
	
	const XML_PATH_SANDBOX_MODE = 'onestepcheckout/paypallogin/sandbox';
	
	const XML_PATH_CLIENT_ID = 'onestepcheckout/paypallogin/clientid';
	
	const XML_PATH_CLIENT_SECRET = 'onestepcheckout/paypallogin/secret';
	...
	public function linkAccounts($_profile, $customer) {
		...
		$paypalCustomer = Mage::getModel ( 'onestepcheckout/paypal_customer' )->load ( $customerId, 'customer_id' );
	...
	public function getLoginUrl() {
		return $this->_getUrl ( 'onestepcheckout/paypal/login', array (
				'_secure' => true 
		) );
	}
	...
	public function getAskLinkPostActionUrl() {
		...
		return $this->_getUrl ( 'onestepcheckout/paypal/askLinkPost', $params );
	}
