<?php
class QSoft_Onestepcheckout_Block_Wrapper extends  Mage_Core_Block_Template{
	...
	protected function _getReviewHtml(){
		...
		$review->setTemplate('qsoft/onestepcheckout/onepage/review/info.phtml');
	...
	public function getJsonConfig() {
		...
		$config['paypalLightBoxEnabled'] = Mage::helper('onestepcheckout')->getPayPalLightboxEnabled();
	...
	protected function getDesignStylesFor_PlaceOrderButton()
	{
		...
		$plbgcolor = Mage::getStoreConfig('onestepcheckout/design/plbgcolor');
		$plovercolor = Mage::getStoreConfig('onestepcheckout/design/plovercolor');
		$pltextcolor = Mage::getStoreConfig('onestepcheckout/design/pltextcolor');
		$plhovertextcolor = Mage::getStoreConfig('onestepcheckout/design/plhovertextcolor');
	...
	protected function getDesignStylesFor_OtherButton()
	{
		...
		$btnbgcolor = Mage::getStoreConfig('onestepcheckout/design/btnbgcolor');
		$btnovercolor = Mage::getStoreConfig('onestepcheckout/design/btnovercolor');
		$btntextcolor = Mage::getStoreConfig('onestepcheckout/design/btntextcolor');
		$btnhovertextcolor = Mage::getStoreConfig('onestepcheckout/design/btnhovertextcolor');
	...
	protected function getDesignStylesFor_LoginButton()
	{
		...
		$bgcolor = Mage::getStoreConfig('onestepcheckout/design/loginbgcolor');
		$overcolor = Mage::getStoreConfig('onestepcheckout/design/loginovercolor');
		$textcolor = Mage::getStoreConfig('onestepcheckout/design/logintextcolor');
		$hovertextcolor = Mage::getStoreConfig('onestepcheckout/design/loginhovertextcolor');
