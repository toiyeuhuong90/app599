<?php
class QSoft_Onestepcheckout_Block_Customer_Account_Dashboard_Info extends Mage_Customer_Block_Account_Dashboard_Info{
    ...
    public function getPaypalCustomerEmail(){
        ...
        $paypalCustomerData =  Mage::getModel('onestepcheckout/paypal_customer')-> getPaypalCustomerDataByField('customer_id', $customerId);
    ...
    public function getUnlinkUrl(){
        return Mage::getUrl('onestepcheckout/paypal/unlink');
    }
    ...
    public function getAuthLoginUrl(){
        return Mage::getUrl('onestepcheckout/paypal/login');
    }
}
