<?php
class QSoft_Onestepcheckout_Block_Adminhtml_System_Config_Form_Field_Merchant extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    protected function _getToken(){
        ...
        foreach ($payments as $paymentCode=>$paymentModel) {
            ...
            if ($paymentCode=='paypal_express'){
                $api = Mage::getModel('onestepcheckout/paypal');
                ...
                $api = Mage::getModel('onestepcheckout/paypaluk');
