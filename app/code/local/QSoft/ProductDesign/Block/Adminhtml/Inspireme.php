 ...
 */
class QSoft_ProductDesign_Block_Adminhtml_Inspireme extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = "adminhtml_inspireme";
        $this->_blockGroup = "productdesign";
        $this->_headerText = Mage::helper("productdesign")->__("Inspire Me Management");
