 ...
 * Time: 14:17
 */ 
class QSoft_ProductDesign_Block_Adminhtml_Cms_Block_Edit_Form extends Mage_Adminhtml_Block_Cms_Block_Edit_Form {
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('is_size_chart', 'select', array(
            'label'     => Mage::helper('cms')->__('Is SizeChart'),
            'title'     => Mage::helper('cms')->__('Is SizeChart'),
            'name'      => 'is_size_chart',
            'required'  => false,
            'options'   => array(
