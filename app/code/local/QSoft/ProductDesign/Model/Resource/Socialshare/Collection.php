 ...
 */
class QSoft_ProductDesign_Model_Resource_Socialshare_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    public function _construct()
    {
        $this->_init('productdesign/socialshare');
    }
