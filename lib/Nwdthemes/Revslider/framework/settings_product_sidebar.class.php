<?php
	class UniteSettingsProductSidebarRev extends UniteSettingsOutputRev{
			...
			foreach($items as $value=>$text):
				...
				?>
					<div class="radio_inner_wrapper">
						...
						<label for="<?php echo $radioID?>" style="cursor:pointer;"><?php echo Mage::helper('nwdrevslider')->__($text)?></label>
					</div>
				<?php
			endforeach;
			?>
		...
		protected function drawCustom($setting){
			Mage::helper('nwdrevslider')->dmp($setting);
			exit();
		}
		...
		protected function drawTextRow($setting){
			...
			?>
				<span class="spanSettingsStaticText"><?php echo __($setting["text"])?></span>
			<?php
		}
		...
		public function drawShadowTypes($current){
			...
			<li  class="shadowTypes shadowType-0"<?php echo ($current == 0) ? ' style="display: none;"' : ''; ?>>
				<img class="shadowTypes shadowType-1" src="<?php echo Mage::getDesign()->getSkinUrl('images/nwdthemes/revslider/shadow1.png'); ?>"<?php echo ($current == 1) ? '' : ' style="display: none;"'; ?> width="271" />
				<img class="shadowTypes shadowType-2" src="<?php echo Mage::getDesign()->getSkinUrl('images/nwdthemes/revslider/shadow2.png'); ?>"<?php echo ($current == 2) ? '' : ' style="display: none;"'; ?> width="271" />
				<img class="shadowTypes shadowType-3" src="<?php echo Mage::getDesign()->getSkinUrl('images/nwdthemes/revslider/shadow3.png'); ?>"<?php echo ($current == 3) ? '' : ' style="display: none;"'; ?> width="271" />
			</li>
			<script type="text/javascript">
				/**
				 * set shadow type
		...
		public function drawCssEditor(){
			?>
			<div id="css_editor_wrap" title="<?php echo Mage::helper('nwdrevslider')->__("Style Editor") ?>" style="display:none;">
				...
				<div id="css-editor-accordion">
					<h3><?php echo Mage::helper('nwdrevslider')->__("Simple Editor:")?></h3>
					<div class="css_editor_novice_wrap">
						<table style="border-spacing:0px">
							<tr class="css-edit-enable"><td colspan="4"><input class="css_edit_novice" type="checkbox" name="css_allow" /> <?php echo Mage::helper('nwdrevslider')->__("enable ") ?> <span id="css_editor_allow"></span></td></tr>
							...
							<tr>
								<td><?php echo Mage::helper('nwdrevslider')->__("Family:") ?></td>
								<td>
								...
								<td><?php echo Mage::helper('nwdrevslider')->__("Size:") ?></td>
								<td>
							...
							<tr>
								<td><?php echo Mage::helper('nwdrevslider')->__("Color:") ?></td>
								...
								<td><?php echo Mage::helper('nwdrevslider')->__("Line-Height:") ?></td>
								<td>
							...
							<tr>
								<td><?php echo Mage::helper('nwdrevslider')->__("Padding:") ?></td>
								<td>
								...
								<td><?php echo Mage::helper('nwdrevslider')->__("Weight:") ?></td>
								<td>
							...
							<tr>
								<td><?php echo Mage::helper('nwdrevslider')->__("Style:") ?></td>
								<td><input type="checkbox" name="css_font-style" class="css_edit_novice" /> <?php echo Mage::helper('nwdrevslider')->__("italic") ?></td>

								<td><?php echo Mage::helper('nwdrevslider')->__("Decoration:") ?></td>
								<td>
							...
							<tr>
								...
								<td><?php echo Mage::helper('nwdrevslider')->__("Transparency:") ?></td>
								<td>
							...
							<tr>
								...
								<td><?php echo Mage::helper('nwdrevslider')->__("Width:") ?></td>
								<td>
							...
							<tr>
								...
								<td><?php echo Mage::helper('nwdrevslider')->__("Radius:") ?></td>
								<td>
									<div class="sub_main_wrapper">
					...
					<h3 class="notopradius" style="margin-top:20px"><?php echo Mage::helper('nwdrevslider')->__("Advanced Editor:")?></h3>
					<div>
			...
			<div id="dialog-change-css" title="<?php echo Mage::helper('nwdrevslider')->__("Save Styles") ?>" style="display:none;">
				<p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 50px 0;"></span><?php
				echo Mage::helper('nwdrevslider')->__('Overwrite the current selected class ');
				echo '"<span id="current-class-handle"></span>"';
				echo Mage::helper('nwdrevslider')->__(' or save the styles as a new class?')?></p>
			</div>

			<div id="dialog-change-css-save-as" title="<?php echo Mage::helper('nwdrevslider')->__("Save As") ?>" style="display:none;">
				<p>
					<?php echo Mage::helper('nwdrevslider')->__('Save as class:')?><br />
		...
		public function drawGlobalCssEditor(){
			?>
			<div id="css_static_editor_wrap" title="<?php echo Mage::helper('nwdrevslider')->__("Global Style Editor") ?>" style="display:none;">
				<div id="css-static-accordion">
					<h3><?php echo Mage::helper('nwdrevslider')->__("Dynamic Styles (Not Editable):")?></h3>
					<div class="css_editor_novice_wrap">
						<textarea id="textarea_show_dynamic_styles" rows="20" cols="81"></textarea>
					</div>
					<h3 class="notopradius" style="margin-top:20px"><?php echo Mage::helper('nwdrevslider')->__("Static Styles:")?></h3>
					<div>
			...
			<div id="dialog-change-css-static" title="<?php echo Mage::helper('nwdrevslider')->__("Save Static Styles") ?>" style="display:none;">
				<p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 50px 0;"></span><?php echo Mage::helper('nwdrevslider')->__('Overwrite current static styles?')?></p>
			</div>
			<?php
		}
	}
