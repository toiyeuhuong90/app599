<?php
 ...
 class UniteBaseAdminClassRevOriginal extends UniteBaseClassRev{
		...
		protected static function updatePlugin($viewBack = false){
			...
			try{
				...
				Mage::helper('nwdrevslider')->dmp("Update in progress...");
				...
				*/
				...
				Mage::helper('nwdrevslider')->dmp("Updated Successfully, redirecting...");
