<?php
	...
	class RevOperationsOriginal extends UniteElementsBaseRev{
		...
		* update language filter in session
		...
		public function checkPurchaseVerification($data){
			...
			if($version_info == 'valid'){
				Mage::getModel('nwdrevslider/options')->updateOption('revslider-valid', 'true');
				Mage::getModel('nwdrevslider/options')->updateOption('revslider-api-key', $data['api_key']);
				Mage::getModel('nwdrevslider/options')->updateOption('revslider-username', $data['username']);
				Mage::getModel('nwdrevslider/options')->updateOption('revslider-code', $data['code']);
		...
		public function doPurchaseDeactivation($data){
			...
			$key = Mage::getModel('nwdrevslider/options')->getOption('revslider-api-key', '');
			$name = Mage::getModel('nwdrevslider/options')->getOption('revslider-username', '');
			...
			if($version_info == 'valid'){
				//Mage::getModel('nwdrevslider/options')->updateOption('revslider-api-key', '');
				//Mage::getModel('nwdrevslider/options')->updateOption('revslider-username', '');
				//Mage::getModel('nwdrevslider/options')->updateOption('revslider-code', '');
				Mage::getModel('nwdrevslider/options')->updateOption('revslider-valid', 'false');
